<section class="content-header">
	<div class="content-header-left">
		<h1>Add Right Slider</h1>
	</div>
	<div class="content-header-right">
		<a href="<?=base_url('Master/slider/right_slider');?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="<?=base_url('Master/slider/addRightSlider');?>" method="post" enctype="multipart/form-data">
