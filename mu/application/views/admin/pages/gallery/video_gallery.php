...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/gallery/add_video');?>" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
	            ...
	            <?php
	            	...
	            	foreach ($statement->result() as $row) {
			            ...
			            <tr>
			                ...
			                <td>
			                    <a href="<?=base_url('Master/gallery/edit_video/'.$row->video_id);?>" class="btn btn-primary btn-xs">Edit</a>
			                    <a href="#" class="btn btn-danger btn-xs" data-href="<?=base_url('Master/gallery/delete_video/'.$row->video_id);?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
			                </td>
			            </tr>
			            <?php
	            	}
