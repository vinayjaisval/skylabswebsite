...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/team/add');?>" class="btn btn-primary btn-sm">Add Team Member</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($statement->result() as $row) {
								...
								<tr>
									...
									<td>										
										<a href="<?=base_url('Master/team/edit/'.$row->id);?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="#" class="btn btn-danger btn-xs" data-href="<?=base_url('Master/team/delete/'.$row->id);?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
									</td>
								</tr>
								<?php
							}
