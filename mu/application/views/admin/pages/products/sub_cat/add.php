...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="<?=base_url('Master/products/addSubCatValues');?>" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control select2" name="category_id">
									...
									<?php
$statement = $this->db->query("SELECT * FROM tbl_category_prod ORDER BY category_id ASC");					
