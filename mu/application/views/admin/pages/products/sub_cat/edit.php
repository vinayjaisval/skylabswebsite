...
<?php
$statement = $this->db->query("SELECT * FROM tbl_sub_category_prod WHERE id=".$id);
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/products/sub_category');?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="<?=base_url('Master/products/updateSubCategory');?>" method="post">
                    ...
                    <label for="" class="col-sm-3 control-label">Select Category <span>*</span></label>
                        <div class="col-sm-4">
                                <select class="form-control select2" name="category_id">
                                    <?php
                                    $statement1 = $this->db->query("SELECT * FROM tbl_category_prod ORDER BY category_id ASC");                  
