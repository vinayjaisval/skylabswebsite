  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-1">
                <img src="<?=base_url('assets/admin/uploads/'.$rowH->home_12)?>" style="width: 55px;background: #f5f5f5;padding: 5px;border-radius: 20px;">
          </div>
          <div class="col-md-11">
            <h4 style="font-weight: 600;color:green">
            <?=$rowH->home_13;?> </h1>
              <p style="text-align:justify;"><?=$rowH->home_14;?> </p>
          </div>
          <div class="col-md-1">
            <img src="<?=base_url('assets/admin/uploads/'.$rowH->home_3)?>" style="width: 55px;background: #f5f5f5;padding: 5px;border-radius: 20px;">
          </div>
          <div class="col-md-11">
            <h4 style="font-weight: 600;color:green">
              <?=$rowH->home_4;?>
            </h1>
              <p style="text-align:justify;"><?=$rowH->home_5;?></p>
          </div>
          <div class="col-md-1">
            <img src="<?=base_url('assets/admin/uploads/'.$rowH->home_6)?>" style="width: 55px;background: #f5f5f5;padding: 5px;border-radius: 20px;">
          </div>
          <div class="col-md-11">
            <h4 style="font-weight: 600;color:green">
              <?=$rowH->home_7;?> 
            </h1>
              <p style="text-align:justify;"><?=$rowH->home_8;?></p>
          </div>
          <div class="col-md-1">
            <img src="<?=base_url('assets/admin/uploads/'.$rowH->home_9)?>" style="width: 55px;background: #f5f5f5;padding: 5px;border-radius: 20px;">
          </div>
          <div class="col-md-11">
            <h4 style="font-weight: 600;color:green">
            <?=$rowH->home_10;?>  </h1>
              <p style="text-align:justify;"><?=$rowH->home_11;?> </p>
          </div>
      ...
      <!---
      <div class="col-10 col-md-4 mx-auto ml-md-auto appear-animation" data-appear-animation="fadeInUpShorter">
        <div class="main_div">
          <div style="background:#f8f6ff;border-bottom: 3px solid green;border-radius: 10px;">
            <h2 style="font-weight:700;color:#2e3c74;padding-bottom: 0px;"> <?=$rowH->home_15;?> </h2>
            <p style="text-align:center"> <?=$rowH->home_16;?></p>
          </div>
          <form action="" style="padding: 20px;">
            <input type="text" id="fname" name="firstname" placeholder="Your name.." required>
            <input type="text" id="lname" name="lastname" placeholder="Enter Your Email.." required>
            <input type="text" id="lname" name="lastname" placeholder=" Enter Your Phone No" required>
            <textarea id="subject" name="subject" placeholder="Enter Your Message.." style="height:80px"></textarea>
            <input type="submit" value="Submit" style="width:100%">
            <br>
            <br>
            <h6 style="text-align: center;">
              <i class="fa fa-lock" aria-hidden="true" style="font-size: 20px;color:gray"></i> <?=$rowH->home_17;?>
            </h6>
          </form>
        </div>
      </div>
...
<section class="user-blog" style="background: url(<?=base_url('assets/');?>img/world-map.png);">
  <div class="container">
    ...
    <!--<p style="text-align:center"> amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor.</p>--->
    <br>
    <div id="demo1">
      <div class="span12">
      ...
      <div class="brand-carousel section-padding owl-carousel">
        ...
        ?>
                          <div class="single-logo">
                              <img src="<?php echo base_url('assets/admin/uploads/'.$row->photo); ?>" style="height:100px;width:100px" alt="">
                          </div>
        <?php } ?>
        ...
        <div id="owl-demo" class="owl-carousel owl-theme">
          ...
          ?>
          <div>
            <img src="<?php echo base_url('assets/admin/uploads/'.$row->photo); ?>" />
          </div>
          <?php } ?>
        </div>
        -- >
