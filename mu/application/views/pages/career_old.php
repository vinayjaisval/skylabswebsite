						...
						<div class="tab-content" id="tabVerticalContent">
							<div class="tab-pane fade pb-4 show active" id="vertical-portfolio" role="tabpanel" aria-labelledby="vertical-portfolio-tab">
								...
								<div class="container-fluid1">
									<form class="contact-form" action="<?php echo base_url(); ?>Main/docontactcareer" method="post">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												<input type="tel" value="" data-msg-required="Please enter your mobile no."minlength="10" maxlength="10" class="form-control onlynumbers" name="mobile" id="mobile" placeholder="Mobile No" required>
											</div>
											<div class="form-group col-md-6">
												<input type="tel" value="" data-msg-required="Please enter your experience." data-msg-email="Please enter a valid email address." class="form-control" name="experience" id="experience" minlength="10"maxlength="10" placeholder="Experience" required>
											</div>
										</div>
										<!-- <div class="form-row">
