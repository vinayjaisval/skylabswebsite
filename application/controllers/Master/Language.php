...
class Language extends CI_Controller {
	...
	public function view(){
		...
		$data['title'] = "Language";
		$data['cur_page'] = 'language';
		$data['cur_sub_page'] = '';
		$data['menu'] = $this->admin->fetch_data('tbl_user');

		$this->load->view('admin/inc/header', $data);
		$this->load->view('admin/pages/language/view');
	...
	public function add(){
		...
		$this->load->view('admin/inc/header', $data);
		$this->load->view('admin/pages/language/add');
		$this->load->view('admin/inc/footer');
	}
	...
	public function addNewUser(){
		...
		if( !empty($post['name']) && !empty($post['link']) && !empty($post['role']) ){
			...
			$this->admin->insert('lanuage', $data);
			$this->session->set_flashdata('success','Lanuage Add Successfully!!');
		    redirect(base_url('Master/language/add'));
		} else {
	...
	public function edit($id){
		...
		$this->load->view('admin/inc/header', $data);
		$this->load->view('admin/pages/language/edit');
		$this->load->view('admin/inc/footer');
	}
	...
	public function updateUser(){
		...
		if( !empty($post['name']) && !empty($post['link']) && $post['role']){
			...
			$this->admin->update('lanuage', $data, $post['id']);
			$this->session->set_flashdata('success','Lanuage Update Successfully!!');
			redirect(base_url('Master/language/edit/'.$post['id']));
		} else {
			$this->session->set_flashdata('error','Please Fill Required Field First!!');
		    redirect(base_url('Master/language/edit'));
		}
	...
	public function delete($id){
		...
		$this->db->delete('lanuage', array('id' => $id));
		$this->session->set_flashdata('success','Add Delete Successfully!!');
	    redirect(base_url('Master/language/view'));
	}
