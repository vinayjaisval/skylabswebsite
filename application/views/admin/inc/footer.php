	...
	<script src="<?=base_url('assets/admin/');?>js/jquery.inputmask.date.extensions.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/jquery.inputmask.extensions.js"></script>
	...
	<script src="<?=base_url('assets/admin/');?>js/jquery.fancybox.pack.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/app.min.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/jscolor.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/on-off-switch.js"></script>
    <script src="<?=base_url('assets/admin/');?>js/on-off-switch-onload.js"></script>
	<script src="<?=base_url('assets/admin/');?>ckeditor/ckeditor.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/demo.js"></script>
	
	<script src="http://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>
	<script src="<?=base_url('assets/admin/');?>js/tags.js"></script>
