<?php
$statement = $this->db->query("SELECT * FROM tbl_menu_one WHERE id=".$id);
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/menu_one/view');?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				<div class="tab-pane <?php if($menu_type == 'Page') {echo 'active';} ?>" id="tab_1">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_one/updateFirstMenu')?>" method="post">
      				...
      				<div class="tab-pane <?php if($menu_type == 'Other') {echo 'active';} ?>" id="tab_2">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_one/updateSecondMenu');?>" method="post">
                            <input type="hidden" name="id" value="<?=$id;?>">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
