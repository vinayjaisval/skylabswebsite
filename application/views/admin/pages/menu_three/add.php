			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				<div class="tab-pane active" id="tab_1">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_three/saveFirstMenu')?>" method="post">
...
?>
      				...
      				<div class="tab-pane" id="tab_2">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_three/saveSecondMenu');?>" method="post">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
