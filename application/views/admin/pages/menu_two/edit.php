<?php
$statement = $this->db->query("SELECT * FROM tbl_menu_two WHERE id=".$id);
			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				<div class="tab-pane <?php if($menu_type == 'Page') {echo 'active';} ?>" id="tab_1">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_two/updateFirstMenu')?>" method="post">
      				...
      				<div class="tab-pane <?php if($menu_type == 'Other') {echo 'active';} ?>" id="tab_2">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu_two/updateSecondMenu');?>" method="post">
                            <input type="hidden" name="id" value="<?=$id;?>">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
