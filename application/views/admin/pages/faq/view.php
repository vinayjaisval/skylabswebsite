...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/faq/add');?>" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
	            ...
	            <?php
	            	...
	            	foreach ($statement->result() as $row) {
			            ...
			            <tr>
			                ...
			                <td>
			                    <a href="<?=base_url('Master/faq/edit/'.$row->faq_id);?>" class="btn btn-primary btn-xs">Edit</a>
			                    <a href="#" class="btn btn-danger btn-xs" data-href="<?=base_url('Master/faq/delete/'.$row->faq_id);?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
			                </td>
			            </tr>
			            <?php
	            	}
