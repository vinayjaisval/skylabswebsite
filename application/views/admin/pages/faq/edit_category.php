...
<?php
$statement = $this->db->query("SELECT * FROM tbl_faq_category WHERE faq_category_id=".$id);
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/faq/category');?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="<?=base_url('Master/faq/updateFaqCat');?>" method="post">
