...
<?php
$statement = $this->db->query("SELECT * FROM tbl_sub_category WHERE id=".$id);
?>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal" action="<?=base_url('Master/news/updateSubCategory');?>" method="post">
                    ...
                    <label for="" class="col-sm-2 control-label">Select Category <span>*</span></label>
                        <div class="col-sm-4">
                                <select class="form-control select2" name="category_id">
                                    <?php
                                    $statement1 = $this->db->query("SELECT * FROM tbl_category ORDER BY category_id ASC");                  
