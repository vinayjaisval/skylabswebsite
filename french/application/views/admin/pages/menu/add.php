			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				<div class="tab-pane active" id="tab_1">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu/saveFirstMenu')?>" method="post" enctype="multipart/form-data">
...
foreach ($q->result() as $row) {
	if($row->page_id==0) {
        ...
        foreach ($r->result() as $row1) {
        	echo '<option value="'.$row->id.'">'.$row1->page_name.'</option>';
        }
    }
}
?>
      				...
      				<div class="tab-pane" id="tab_2">
						...
						<form class="form-horizontal" action="<?=base_url('Master/menu/saveSecondMenu');?>" method="post" enctype="multipart/form-data">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
