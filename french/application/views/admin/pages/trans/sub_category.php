      ...
      <thead>
          <tr>
            ...
            <tbody>
              <?php
              $i=0;
              $statement = $this->db->query("SELECT a.*, b.* FROM tbl_sub_category_prod a, tbl_category_prod b WHERE a.status = 0 AND a.`category_id` = b.`category_id` ORDER BY id ASC");            
          ...
          <tr>
                      ...
                      <td>
                          <a href="#" class="btn btn-primary btn-xs" data-href="<?=base_url('Master/trans/active_sub_category/'.$row->id);?>" data-toggle="modal" data-target="#confirm-delete1">Restore</a>
                          <a href="#" class="btn btn-danger btn-xs" data-href="<?=base_url('Master/trans/delete_sub_category/'.$row->id);?>" data-toggle="modal" data-target="#confirm-delete">Permanent Delete</a>
                      </td>
                  </tr>
                <?php
              }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <b>Be Careful!</b> All Products & Sub Sub Category also deleted in this sub category
            </div>
