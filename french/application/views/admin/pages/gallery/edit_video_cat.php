...
<?php
$statement = $this->db->query("SELECT * FROM tbl_category_video WHERE v_category_id=".$id);
?>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="<?=base_url('Master/gallery/update_video_category');?>" method="post">
