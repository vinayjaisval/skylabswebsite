		...
		<div class="col-md-12">
            ...
            <div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li class="active"><a href="<?=base_url('Master/products/prod_detail/'.$id);?>">Product Details</a></li>
				...
				<div class="tab-content">
	  				<div class="tab-pane active" id="tab_1">
	  					<form class="form-horizontal" action="<?=base_url('Master/products/addProduct1_1');?>" method="post" enctype="multipart/form-data">
