            ...
            <div class="nav-tabs-custom">
				...
				<div class="tab-content">
	  				<div class="tab-pane active" id="tab_1">
	  					<form class="form-horizontal" action="<?=base_url('Master/products/addProduct5');?>" method="post" enctype="multipart/form-data">
	  				<input type="hidden" name="id" value="<?=$id;?>">
						...
						<div class="form-group">
				            ...
				            <div class="col-md-2" style="margin-bottom: 10px;">
				            	<label>
								<input <?php if( in_array($row->id, $submenuColor)){	echo "checked";	} ?> type="checkbox" name="colors[]" value="<?=$row->id;?>">
				            	<span style="display: inline-block; width: 50px; height: 50px; border-radius: 50%; background-color: #<?=$row->name;?>; vertical-align: middle;"></span></label>
				            </div>
				        	<?php } ?>
				        	</div>
				        	</div>
