<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url('Master/language/view');?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>

<?php
$statement = $this->db->query("SELECT * FROM lanuage WHERE id=".$id);
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="<?=base_url('Master/language/updateUser');?>" method="post" enctype="multipart/form-data">
